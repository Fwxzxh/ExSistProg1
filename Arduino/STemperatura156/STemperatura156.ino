...
void loop()
{
  ...
  //humedad = ((float)DHT11.humidiy, 2)
  Serial.print((float)DHT11.humidity, 2);//Hago uso de la libreria
  Serial.print("\n");
  delay(1000);
  ...
  Serial.print("LP: ");
  Serial.print(porcentaje_gas(lecturaMQ(MQ1) / Ro, GAS_LP) );//Calculo el % de gas y lo mando
  Serial.print("\n");
  Serial.print("CO: ");
  Serial.print(porcentaje_gas(lecturaMQ(MQ1) / Ro, GAS_CO) );
  Serial.print("\n");
  delay(1000);
